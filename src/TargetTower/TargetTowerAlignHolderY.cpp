/*
 *************************************************************************
 * @file TargetTowerAlignHolderY.cpp
 *
 * CS Target Tower
 *
 *  Author: Ondrej Janda
...
namespace targetTower{
    ...
    bool TargetTower::alignHolderY(){
        ...
        for (uint32_t i = 0; i < alignment.maxAlignmentSteps; i++) {
            ...
            if(startFromTop){
                //focus at P1
                if(!focusAtPoint(alignment.alignmentPoints.holder1.h3, finalZaxisP1, repeated)){
                ...
                //focus at P3
                if(!focusAtPoint(alignment.alignmentPoints.holder1.h4, finalZaxisP3, repeated)){
